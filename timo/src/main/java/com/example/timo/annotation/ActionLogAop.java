package com.example.timo.annotation;




import com.example.timo.action.base.BaseActionMap;
import com.example.timo.action.base.ResetLog;
import com.example.timo.action.model.ActionModel;
import com.example.timo.action.model.BusinessMethod;
import com.example.timo.action.model.BusinessType;
import com.example.timo.service.ActionLogService;
import com.example.timo.utils.ShiroUtil;
import com.example.timo.utils.SpringContextUtil;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.example.timo.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        // 封装日志实例对象
        com.example.timo.pojo.ActionLog actionLog = new com.example.timo.pojo.ActionLog();
